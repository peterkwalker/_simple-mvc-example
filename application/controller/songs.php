...
class Songs extends Controller
{
    ...
    public function addSong()
    {
        ...
        header('location: ' . URL . 'songs/index?action=The song has been added to the database.');
    }
    ...
    public function deleteSong($song_id)
    {
        ...
        header('location: ' . URL . 'songs/index?action=The song has been deleted from the database.');
    }
    ...
    public function view($song_id)
    {
        ...
        if (isset($song_id)) {
            ...
            // load views. within the views we can echo out $song easily
            require APP . 'view/_templates/header.php';
            require APP . 'view/songs/view.php';
            require APP . 'view/_templates/footer.php';
        } else {
            // redirect user to songs index page (as we don't have a song_id)
            header('location: ' . URL . 'songs/index');
    ...
    public function updateSong()
    {
        ...
        // where to go after song has been updated
        header('location: ' . URL . 'songs/index?action=The song has been updated.');
    }
